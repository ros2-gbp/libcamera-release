...
%define __spec_install_post \
    ...
    %{__arch_install_post} \
    %{__os_install_post} \
    %{_builddir}/%{name}-%{version}/src/ipa/ipa-sign-install.sh %{_builddir}/%{name}-%{version}/%{_vpath_builddir}/src/ipa-priv-key.pem %{buildroot}//opt/ros/humble/lib/libcamera/ipa_*.so \
%{nil}
...
%changelog
* Tue Sep 03 2024 Christian Rauch <Rauch.Christian@gmx.de> - 0.1.0-3
- Autogenerated by Bloom

* Mon Sep 02 2024 Christian Rauch <Rauch.Christian@gmx.de> - 0.1.0-2
- Autogenerated by Bloom

* Thu May 09 2024 Christian Rauch <Rauch.Christian@gmx.de> - 0.2.0-3
- Autogenerated by Bloom

* Thu May 09 2024 Christian Rauch <Rauch.Christian@gmx.de> - 0.2.0-2
- Autogenerated by Bloom

* Tue Jan 09 2024 Christian Rauch <Rauch.Christian@gmx.de> - 0.2.0-1
- Autogenerated by Bloom
