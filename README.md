## libcamera (lyrical) - 0.7.2-1

The packages in the `libcamera` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release libcamera --rosdistro lyrical` on `Fri, 10 Jul 2026 20:39:32 -0000`
...
## libcamera (jazzy) - 0.7.2-1

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release libcamera --rosdistro jazzy` on `Fri, 10 Jul 2026 20:37:33 -0000`
...
## libcamera (rolling) - 0.7.2-1

The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release libcamera --rosdistro rolling` on `Fri, 10 Jul 2026 20:34:37 -0000`
...
## libcamera (lyrical) - 0.7.1-2

The packages in the `libcamera` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release libcamera --rosdistro lyrical` on `Tue, 12 May 2026 06:12:21 -0000`
...
## libcamera (rolling) - 0.7.1-2

The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release libcamera --rosdistro rolling` on `Tue, 12 May 2026 06:09:23 -0000`
...
## libcamera (lyrical) - 0.7.1-1

The packages in the `libcamera` repository were released into the `lyrical` distro by running `/home/christian/.local/bin/bloom-release libcamera --rosdistro lyrical` on `Sat, 09 May 2026 16:20:31 -0000`
...
## libcamera (rolling) - 0.7.1-1

The packages in the `libcamera` repository were released into the `rolling` distro by running `/home/christian/.local/bin/bloom-release libcamera --rosdistro rolling` on `Sat, 09 May 2026 16:11:30 -0000`
...
## libcamera (jazzy) - 0.7.1-1

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release libcamera --rosdistro jazzy` on `Tue, 28 Apr 2026 21:21:42 -0000`
...
The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release libcamera --rosdistro rolling` on `Tue, 28 Apr 2026 21:13:19 -0000`
...
The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release libcamera --rosdistro rolling` on `Tue, 28 Apr 2026 21:09:26 -0000`
...
## libcamera (jazzy) - 0.7.0-1

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release libcamera --rosdistro jazzy` on `Thu, 29 Jan 2026 18:34:44 -0000`
...
## libcamera (rolling) - 0.7.0-1

The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release libcamera --rosdistro rolling` on `Thu, 29 Jan 2026 18:30:48 -0000`
...
## libcamera (jazzy) - 0.6.0-1

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release libcamera --rosdistro jazzy` on `Thu, 27 Nov 2025 13:05:50 -0000`
...
## libcamera (rolling) - 0.6.0-1

The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release libcamera --rosdistro rolling` on `Thu, 27 Nov 2025 12:36:14 -0000`
...
## libcamera (jazzy) - 0.5.2-2

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release libcamera --rosdistro jazzy` on `Fri, 31 Oct 2025 22:17:20 -0000`
...
## libcamera (rolling) - 0.5.2-3

The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling libcamera` on `Fri, 17 Oct 2025 06:02:20 -0000`
...
## libcamera (rolling) - 0.5.2-2

The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling libcamera` on `Fri, 10 Oct 2025 20:37:10 -0000`
...
## libcamera (jazzy) - 0.5.2-1

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy libcamera` on `Wed, 13 Aug 2025 17:30:11 -0000`
...
## libcamera (rolling) - 0.5.2-1

The packages in the `libcamera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling libcamera` on `Sat, 09 Aug 2025 18:16:29 -0000`
...
## libcamera (rolling) - 0.5.1-1

The packages in the `libcamera` repository were released into the `rolling` distro by running `/home/christian/.local/bin/bloom-release libcamera -r rolling` on `Mon, 16 Jun 2025 16:46:53 -0000`
...
## libcamera (jazzy) - 0.5.1-1

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/home/christian/.local/bin/bloom-release libcamera -r jazzy` on `Mon, 16 Jun 2025 16:43:46 -0000`
